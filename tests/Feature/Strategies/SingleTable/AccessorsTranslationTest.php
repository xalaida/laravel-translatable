...
class AccessorsTranslationTest extends TestCase
{
    ...
    private function createSchema(): void
    {
        $this->schema()->create('books', function (Blueprint $table) {
            $table->id();
            // TODO: translatable attributes are located in the single (global sounds better) translation table
            // $table->string('title');
    ...
    // TODO: fallback attributes not exists here... (setting locale to custom to fix)
    /** @test */
...
// TODO: fallback attributes not exists here...
//    /** @test */
