...
class ExtraTableExtendedStrategyTest extends TestCase
{
    /**
     * @inheritdoc
     */
    ...
    /** @test */
    public function it_stores_translations_using_extra_table_extended_strategy(): void
    {
        $book = new Book();
    ...
    /** @test */
    public function it_retrieves_translations_using_extra_table_extended_strategy(): void
    {
        $book = new Book();
        $book->translator()->set('title', 'Amazing birds', 'en');
        $book->translator()->set('title', 'Дивовижні птахи', 'uk');
    ...
    public function it_returns_null_if_translation_is_nullable(): void
    {
        ...
        static::assertNull($book->translator()->get('description', 'en'));
    }
